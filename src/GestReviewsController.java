...
/**
 * Escreva a descri��o da classe GestReviewsController aqui.
 * 
 * @author (seu nome) 
 * @version (n�mero de vers�o ou data)
 */
public class GestReviewsController extends Observable implements Observer
{
    private int comando;
    ...
    public GestReviewsController (GestReviews model) {
        this.comando = 0;
    ...
    public void processaComando (List<String> args) {
        switch (this.comando) {
            ...
            case 3: this.carregaEstadoTexto (args) ;
                    break;
            case 4: this.estatistica1 ();
                    break;
            case 5: this.estatistica2();
                    break;
            case 6: this.query1();
                    break;
            case 7: this.query2(args);
                    break;
            case 8: this.query3(args.get(0));
                    break;
            case 9: this.query4(args.get(0));
                    break;
            case 10: this.query5(args.get(0));
                    break;
            case 11: this.query6(args.get(0));
                    break;
            case 12: this.query7();
                    break;
            case 13: this.query8(args.get(0));
                    break;
            case 14: this.query9(args);
                    break;
            case 15: this.query10();
                    break;
            case 16: this.setFriends();
                    break;
        }
    }
    ...
    private void estatistica1 () {
        this.model.estatistica1();
        this.updateView();
    }

    private void estatistica2 () {
        this.model.estatistica2();
        this.updateView();
    }
